/*
 * @(#) GmlToRdf.java	version 1.0   7/4/2014
 *
 ...
 * Last modified by: Kostas Patroumpas, 7/4/2014
 */
public class GmlToRdf 
{
	/**
     * Accept two arguments: the name of an GML file, and the name of the resulting RDF file.
     * EXAMPLE: java -cp lib/*;TripleGeo.jar eu.geoknow.athenarc.triplegeo.GmlToRdf ./data/samples.gml ./data/test1.rdf
     */
